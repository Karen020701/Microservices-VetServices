#### Description
This microservice allows adding medicines to a database in Always Data, to access this microservice a role-based access was created, which in this case must be entered with a Veterinarian credential.
...
Description: This endpoint allows adding a new food to the database.

#### Security
This microservice uses JSON Web Tokens (JWT) for authentication.
Access to the add medicine endpoints is restricted to users with a veterinarian role only.
